...
db.execute('''
    ...
    VALUES ('Peter&Jane','A very boring book, suitable for children aged 3-9',15.99,'../bookImg/p1.jpg')
''')

db.execute('''
    INSERT INTO book(bookName,bookDes,price,imgLink)
    VALUES ('Upin&Ipin','A very boring book, suitable for children aged 3-9',11.99,'../bookImg/p2.jpg')
''')

db.execute('''
    INSERT INTO book(bookName,bookDes,price,imgLink)
    VALUES ('Tom&Jerry','A very boring book, suitable for children aged 3-9',21.99,'../bookImg/p3.jpg')
''')

db.execute('''
    INSERT INTO book(bookName,bookDes,price,imgLink)
    VALUES ('Mickey Mouse','A very boring book, suitable for children aged 3-9',21.99,'../bookImg/p3.jpg')
''')
